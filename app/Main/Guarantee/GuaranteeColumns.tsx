...
},
{
   ...
   subtitle: 'Если по каким-либо причинам вы останетесь недовольны нами – на любом этапе вплоть до установки – мы вернем вам деньги. Без лишних слов и вопросов.'
},
{
   img: service,
   imgAlt: 'service',
...
function GuaranteeColumns() {
   ...
   <div className="grid grid-cols-3 gap-9 text-center mt-12">
      {columns.map((el, idx) => {
         return (
            <div className="column flex flex-col justify-center items-center">
