...
function EquipItem({ el, idx }: equipItemProps) {
   ...
   return (
      <div style={{ width: isItemView ? "100%" : "0%" }} ref={ref} key={idx} className="equip__body py-5 overflow-hidden">
         <div style={{ opacity: isContentView ? 1 : 0 }} className="container equip__container flex justify-around items-center text-center">
            ...
            <div className="flex flex-col items-center equip__title_body">
               <h3 className="equip__title text-4xl">{el.title}</h3>
               <p className="equip__subtitle text-xl mt-7">{el.subtitle}</p>
